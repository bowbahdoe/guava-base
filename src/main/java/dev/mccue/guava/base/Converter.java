...
import static dev.mccue.guava.base.NullnessCasts.uncheckedCastNullableTToT;
 ...
 * example round-trip using {@code dev.mccue.guava.primitives.Doubles#stringConverter}:
 *
 * <ol>
...
public abstract class Converter<A, B> implements Function<A, B> {
  ...
  @LazyInit @CheckForNull private transient Converter<B, A> reverse;
