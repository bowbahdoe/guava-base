...
public final class Objects extends ExtraObjectsMethodsForWeb {
   ...
   * equals()} contract.
   *
   * <p><b>Note:</b> this method is now unnecessary and should be treated as deprecated; use {@code
  ...
  /**
   * Generates a hash code for multiple values. The hash code is generated by calling {@code
   * Arrays#hashCode(Object[])}. Note that array arguments to this method, with the exception of a
   * single Object array, do not get any special handling; their hash codes are based on identity
   * and not contents.
   *
   * <p>This is useful for implementing {@code Object#hashCode()}. For example, in an object that
