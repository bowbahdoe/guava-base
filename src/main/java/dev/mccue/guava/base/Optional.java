...
public abstract class Optional<T> implements Serializable {
  ...
  /**
   * Returns the equivalent {@code dev.mccue.guava.base.Optional} value to the given {@code
   ...
   * dev.mccue.guava.base.Optional}, or {@code null} if the argument is null.
   *
   ...
   * throws {@code IllegalStateException}, whereas the {@code java.util} counterpart throws {@code
